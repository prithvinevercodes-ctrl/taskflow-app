...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self.send_json({'message': 'API endpoint not found'}, 404)
    ...
    def do_POST(self):
        ...
        if path == '/api/auth/register' or path == '/api/auth/register/':
        ...
        elif path == '/api/auth/login' or path == '/api/auth/login/':
            email = data.get('email', '')
            password = data.get('password', '')
        ...
        elif path == '/api/tasks' or path == '/api/tasks/':
            new_task = {
                'id': len(TASKS_DB) + 100,
        ...
        self.send_json({'message': 'Endpoint not found'}, 404)
